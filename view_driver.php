...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        This Driver
        <small>Details of Motorist Demographics</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <span class="username"><a href="#"><?php echo $firstname." ".$middlename." ".$lastname?> </a></span>
            ...
            <p> Gender: <span> <?php echo $sex?></p>
            <p> Address: <span> <?php echo $address?></p>
            <p> National ID: <span> <?php echo $nationalid?></p>
